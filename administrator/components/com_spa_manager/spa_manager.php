...
if (!is_writable(JPATH_SITE.DS.'tmp')) {
	JError::raiseWarning('front-end unwritable', JPATH_SITE.DS.'tmp' . ' is unwritable!');
}

// Load the admin HTML view
require_once( JPATH_COMPONENT.DS.'helpers'.DS.'yos_utility.php' ); 
//require_once( JPATH_SITE .DS. 'components' .DS. 'com_yos_translator' .DS. 'helpers' .DS. 'defines.php' ); 
...
$controllerClass = 'SPAController'.ucfirst($controllerName);
